...
export function changeStyle(theme) {
  ...
  if (theme == 'CSK_Style'){
    ...
    var customBackground =  `.CSK_Module_ModuleName .myCustomBackground_CSK_Module_ModuleName { background-color: #737F8522; }` // font-family: "Open Sans"; }`
    ...
    var customBackground =  `.CSK_Module_ModuleName .myCustomBackground_CSK_Module_ModuleName { background-color: #fff; }` // font-family: "sans-serif"; }`
